    ...
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            CreateMap<Product, ProductDTO>()
                .ForMember(dto => dto.IdCategories, opt => opt.MapFrom(src => src.CategoryProducts.Select(cp => cp.IdCategory)));
            CreateMap<ProductDTO, Product>();
            CreateMap<Category, CategoryDTO>()
                .ForMember(dto => dto.IdProducts, opt => opt.MapFrom(src => src.categoryProducts.Select(cp => cp.IdProduct)));
